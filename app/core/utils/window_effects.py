'''
This file is a part of the Win32Mica project. https://github.com/marticliment/win32mica
Becasue of white flashing issue in dark mode I have included the code from the original project here and made some changes to it.
'''
import ctypes
import sys
import threading
