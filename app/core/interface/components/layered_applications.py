...
class RuleWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.kind = DropdownLayout('Kind', 'Individual applications managed as floating windows', 
                                 ...
                                 config_id=f"layered_applications-{self.index}.kind")
        self.strategy = DropdownLayout('Matching strategy', 'Individual applications matching rules',
                                     ...
                                     config_id=f"layered_applications-{self.index}.matching_strategy")
        self.identifier = InputLayout('ID', 'Identifier as a string', "",
                                    config_id=f"layered_applications-{self.index}.id")
...
class DynamicLayout(QWidget):
    def __init__(self, parent=None):
        ...
        # Connect signal
        signal_manager.layered_applications_updated.connect(self.handle_layered_applications)
        self._initialized = True

    def showEvent(self, event):
        super().showEvent(event)
        
    def handle_layered_applications(self, rules):
...
def layered_applications_widget():
